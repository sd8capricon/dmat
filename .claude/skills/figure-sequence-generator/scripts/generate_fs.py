...
# ---------------------------------------------------------------------------
# Cumulative pacing timer (75s/question budget) -- CSS/JS/markup below are
# copy-pasted byte-identical into the latin-square and math-equation sibling
# scripts (same convention already used for CSS/JS above), and reused as-is
# by mixed-exercise-generator via this module. Never re-derive this logic in
# any of those files; extend it here and re-copy if it ever needs to change.
# ---------------------------------------------------------------------------
